...
module.exports = function(options) {
  ...
  if (client) {
    ...
    return _.merge({}, config, {
      ...
      module: {
        loaders: [
          { test: /\.js?$/, loaders: ['react-hot', 'babel?presets[]=react,presets[]=es2015,plugins[]=transform-decorators-legacy,plugins[]=transform-class-properties'], exclude: /(node_modules|__tests__)/ },
