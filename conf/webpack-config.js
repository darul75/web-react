...
module.exports = function(options) {
  ...
  // html template
  let suffix = '',
      outputPath = path.join(rootDir, 'build');
  ...
  if (client) {
    ...
    return _.merge({}, config, {
      context: path.join(__dirname, path.sep, '..', 'app'),
      entry: {
        app: devMainClientApp,
        vendors: ['classnames', 'iso', 'react', 'react-dom', 'react-helmet', 'react-router', 'react-hot-loader', 'whatwg-fetch']
      },
      output: {
          path: outputPath,
      ...
      module: {
        loaders: [
          { test: /\.js?$/, loaders: ['react-hot', 'babel?presets[]=react,presets[]=es2015,plugins[]=transform-decorators-legacy'], exclude: /(node_modules|__tests__)/ },
    ...
    return _.merge({}, config, {
      ...
      module: {
        loaders: [
          { test: /\.(jsx?)$/, loaders: ['react-hot', 'babel?presets[]=react,presets[]=es2015,plugins[]=transform-decorators-legacy'], exclude: /node_modules/ },
          { test: /\.(jpe?g|png|gif|svg|woff|eot|ttf)$/, loader: 'url?limit=10000&name=[sha512:hash:base64:7].[ext]' },
          { test: /\.sass$/, loader: sassLoaders },
          { test: /\.css$/, loader: cssLoaders },
          { test: /\.scss$/, loader: scssLoaders },
